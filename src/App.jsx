...
function App() {
  ...
  <ul> 
    <li>
      <h3><a href="https://grupoapis.ufsc.br/files/2016/12/ProENF-SA_1_Prevencao-ao-uso-de-drogas-1-1.pdf" className="link">Prevenção:</a></h3><br />
      <p>
    ...
    <li>
      <h3><a href="https://www.gruporecanto.com.br/blog/tipos-de-dependencia-quimica-sintomas-e-tratamentos/" className="link">Tipos de Dependências:</a></h3><br />
      <p>
    ...
    <li>
      <h3><a href="https://hospitalsantamonica.com.br/quais-sao-os-tipos-de-tratamento-para-dependentes-quimicos-mais-indicados/" className="link">Tratamentos:</a></h3><br />
      <p>
    ...
    <li>
      <h3><a href="https://institutosj.com.br/" className="link">Centros de Apoio:</a></h3><br />
      <p>
    ...
    <li>
      <h3><a href="https://www.youtube.com/live/GQq8BU9m1nA?si=BxjNrNWVrgizLhr_" className="link">Vídeos:</a></h3><br />
      <p>
